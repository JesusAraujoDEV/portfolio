// Tiny dependency-free 2D physics sim for the StackWall "falling boxes" tech
// stickers: circle bodies, gravity, wall bounce, mutual separation, mouse
// repel. Deliberately minimal — no engine, no broadphase, just enough to feel
...
export class Wall {
  ...
  private pushFromMouse(b: Body, d: number) {
