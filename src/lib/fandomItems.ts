...
export const fandomItems: FandomItem[] = [
  ...
  {
    key: "amigos-invisibles",
    src: "/images/amigos-invisibles.png",
    alt: "Los Amigos Invisibles",
    caption: "Amo su estilo de música, y que sean venezolanos le suma todavía más.",
    rotate: -5,
    top: "80%",
    left: "2%",
    sizeDesktop: "w-36 md:w-48 lg:w-52",
  ...
  {
    key: "tokyo-ghoul",
    src: "/images/tokyo-ghoul.png",
    alt: "Tokyo Ghoul",
    caption: "Mi manga favorito. No me canso de leerlo — la historia y la estética me tienen enamorado.",
    rotate: 6,
    top: "84%",
    left: "28%",
    sizeDesktop: "w-40 md:w-52 lg:w-56",
  ...
  },
  {
    ...
    alt: "Severance",
    caption: "Una locura de serie. Estoy ansioso por la tercera temporada.",
    rotate: -4,
    top: "78%",
    left: "56%",
    sizeDesktop: "w-40 md:w-52 lg:w-56",
  ...
  {
    key: "21-jump-street",
    src: "/images/21-jump-street.png",
    alt: "21 Jump Street",
    caption: "Amo su comedia. Cada vez que la veo, estallo de risa.",
    rotate: 5,
    top: "86%",
    left: "82%",
    sizeDesktop: "w-36 md:w-48 lg:w-52",
